...
class Tablerate extends \Magento\OfflineShipping\Model\ResourceModel\Carrier\Tablerate
{
    ...
    public function uploadAndImport(\Magento\Framework\DataObject $object)
    {
         ...
         */
        $dataFile = $this->request->getFiles('groups');
        if (!isset($dataFile['tablerate']['fields']['import']['value']['tmp_name']) ||
            empty($dataFile['tablerate']['fields']['import']['value']['tmp_name'])) {
            return $this;
        }
        $filePath = $dataFile['tablerate']['fields']['import']['value']['tmp_name'];
