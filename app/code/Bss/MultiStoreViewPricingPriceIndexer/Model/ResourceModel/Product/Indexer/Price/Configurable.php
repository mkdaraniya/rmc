...
class Configurable implements DimensionalIndexerInterface
{
    ...
    public function executeByDimensions(array $dimensions, \Traversable $entityIds)
    {
        ...
        $temporaryPriceTable = $this->indexTableStructureFactory->create([
            'tableName' => $this->getTable('catalog_product_index_price_store_temp'),
    ...
    private function applyConfigurableOption(
        ...
        $temporaryOptionsTableName = 'catalog_product_index_price_cfg_opt_store_temp';
        $this->getConnection()->createTemporaryTableLike(
            $temporaryOptionsTableName,
            $this->getTable('catalog_product_index_price_cfg_opt_store_tmp'),
            true
        );
    ...
    private function fillTemporaryOptionsTable(string $temporaryOptionsTableName, array $dimensions, array $entityIds)
    {
        ...
        $select = $this->getConnection()->select()->from(
            ['i' => $this->getTable('catalog_product_index_price_store_replica')],
            []
        )->join(
