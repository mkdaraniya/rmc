...
class ListFooterStyles implements \Magento\Framework\Option\ArrayInterface
{
    public function toOptionArray()
    {
        return [
            ...
            ['value' => 'footer-19', 'label' => __('Footer Style 19')],
            ['value' => 'footer-20', 'label' => __('Footer Style 20')],
            ['value' => 'footer-21', 'label' => __('Footer Style 21')],
			['value' => 'footer-22', 'label' => __('Footer Style 22')],
			['value' => 'footer-23', 'label' => __('Footer Style 23')],
        ];
    }
}