...
define([
    ...
    return Component.extend({
        ...
        getShippingAddress: function () {
            ...
            return {
                recipientName: _.isUndefined(address.firstname) &&  _.isUndefined(address.lastname) ? '' : address.firstname + ' ' + address.lastname,
                line1: _.isUndefined(address.street) || _.isUndefined(address.street[0]) ? '' : address.street[0],
                line2: _.isUndefined(address.street) || _.isUndefined(address.street[1]) ? '' : address.street[1],
                city: _.isUndefined(address.city) ? '' : address.city,
                countryCode: _.isUndefined(address.countryId) ? '' : address.countryId,
                postalCode: _.isUndefined(address.postcode) ? '' : address.postcode,
                state: _.isUndefined(address.region) ? '' : address.region
            };
        },
